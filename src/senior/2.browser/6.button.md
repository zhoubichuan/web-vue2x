...
<template>
    <div class="quick-entry">
        ...
        <ul class="content">
            <li
                v-clickoutside="() => item.id && active && handleOutSide(item.id)"
                class="card"
...
.quick-entry {
    ...
    .header {
        ...
        .mine-paper {
            ...
            &:hover {
                background-color: $u3-bg-color-hover;
            }
    ...
    .content {
        ...
        .card {
            ...
            &:hover {
                background-image: linear-gradient(45deg, rgb(182, 227, 255, 0.7), rgba(255, 255, 255, 0.85)),
                    linear-gradient(
                        45deg,
