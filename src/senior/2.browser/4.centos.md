...
export default {
    ...
    computed: {
        listData() {
            return Array.from({ length: 10 }, (i, index) => index);
        },
    },
    methods: {
        handleClick(tip) {
            if (tip === "left") {
                this.$refs.content.scrollLeft -= 30;
            } else {
                this.$refs.content.scrollLeft += 30;
            }
        },
