...
<template>
  <div class="student">
    ...
    <el-table class="student-table" :data="tableData" style="width: 100%">
...
export default {
  ...
  methods: {
    getData() {
      this.$axios
        ?.get("https://zhoubichuan.com/common-node/api/student/queryAll")
        .then((result) => {
    ...
    handleConfirm() {
      ...
      if (this.isAdd) {
        this.$axios
          .post(
            "https://zhoubichuan.com/common-node/api/student/addSingle",
        ...
        this.$axios
          .put(
            "https://zhoubichuan.com/common-node/api/student/update",
            this.$qs.stringify(this.form)
          )
          .then((result) => {
            this.tableData = result.data.data
    ...
    handleDelete(e) {
      ...
      this.$axios
        .delete(
          "https://zhoubichuan.com/common-node/api/student/deleteSingle",
          {
