...
<template>
  <div>
    ...
    <div>b：{{ b }}</div>
    <div>c：{{ c }}</div>
    <div>时间戳转换成时间：{{ $moment(new Date().getTime()).format("YYYY-M-DD") }}</div>
    <div>时间戳转换成时间：{{ $moment(new Date().getTime()).format("YYYY-MM-DD") }}</div>
    <div>时间戳转换成时间：{{ $moment(new Date().getTime()).format("YYYY-MMM-DD") }}</div>
    <div>时间戳转换成时间：{{ $moment(new Date().getTime()).format("YYYY-MMMM-DD") }}</div>
    <div>时间戳转换成时间：{{ $moment(new Date().getTime()).format("YYYY-MM-D") }}</div>
    <div>时间戳转换成时间：{{ $moment(new Date().getTime()).format("YY-MM-DD") }}</div>
  </div>
</template>
<script>
export default {
