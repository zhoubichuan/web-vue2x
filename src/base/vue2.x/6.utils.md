...
export default {
  ...
  methods: {
    getData() {
      this.$axios?.get("/common-node/api/student/queryAll").then((result) => {
    ...
    handleConfirm() {
      ...
      if (this.isAdd) {
        ...
        this.$axios
          .put("/common-node/api/student/update", this.$qs.stringify(this.form))
          .then((result) => {
            this.tableData = result.data.data
          })
      }
    ...
    handleDelete(e) {
      let id =
        e.target.parentNode.parentNode.parentNode.parentNode.children[0]
          .innerText
      this.$axios
        .delete("/common-node/api/student/deleteSingle", {
