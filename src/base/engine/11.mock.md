...
export default {
  ...
  methods: {
    ...
    getHistoryData() {
      ...
      this.list = []
      fetch(
        `http://v.juhe.cn/todayOnhistory/queryEvent.php?key=${key}&date=${date[1]}/${date[2]}`,
        {
          method: "GET",
        }
      ).then(
...
export default {
  ...
  methods: {
    ...
    getIpData() {
      ...
      this.list = []
      fetch(`http://apis.juhe.cn/ip/ipNewV3?key=${key}&ip=${this.value}`, {
        method: "GET",
      }).then(
        (response) => {
          if (!response.error_code) {
...
export default {
  ...
  methods: {
    ...
    getIpData() {
      ...
      this.list = []
      fetch(`http://apis.juhe.cn/cnoil/oil_city?key=${key}`, {
        method: "GET",
      }).then(
        (response) => {
          if (!response.error_code) {
