  ...
  routes: [
    {
      ...
      name: "home",
      component: Home, // ❓页面组件没有进行按需加载，可以使用 `import` 来进行优化
    },
    {
      path: "/about",
      name: "about",
...
改为 history 后我们 url 的路径就变成了 `http://127.0.0.1:8080/vue/about`，而不是原来的 `http://127.0.0.1:8080/vue/#/about`，但是需要注意页面渲染 404 的问题
