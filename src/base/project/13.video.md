...
<template>
  <div>
    ...
    <el-button type="success" @click="playVoice">开始语音播报</el-button>
    <el-button type="warning" @click="handleStop">停止语音播报</el-button>
  </div>
</template>
<script>
...
<template>
  <el-form>
    ...
    <el-button v-on:click="startRecognition">开始语音识别</el-button>
  </el-form>
</template>
