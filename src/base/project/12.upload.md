...
<template>
  <div>
    <el-button @click="downloadFile('file1.pdf')">下载文件1</el-button>
    <el-button @click="downloadFile('file2.jpg')">下载文件2</el-button>
  </div>
</template>
<script>
export default {
